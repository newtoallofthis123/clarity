  ...
  return (
    <div className="mt-4">
      <div className="flex flex-col justify-center">
        <div className="rounded-md border-2 border-neutral-200">
          <Input
            className="w-full rounded-none border-0 border-b-2 border-neutral-200 px-2 py-3 text-xl"
            placeholder="Title"
            value={title}
            onChange={(e) => {
        ...
        <div className="flex flex-row items-center justify-between py-1">
          <Button className="p-2 text-lg" onClick={handleSubmit}>
            Comment
          </Button>
          <div>
            {" "}
